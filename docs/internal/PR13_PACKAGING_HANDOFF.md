...
- `python tools/smoke_test_packaged_backend.py --video "C:\sample-media\test_30s.mp4" --output-dir "C:\Cue_extra\smoke_packaged"` -> `SMOKE_RESULT=PASS`
...
5. Smoke test packaged backend path:
   - `python tools\smoke_test_packaged_backend.py --video "C:\sample-media\test_30s.mp4" --output-dir "C:\Cue_extra\smoke_packaged"`
