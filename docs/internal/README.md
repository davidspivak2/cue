...
- **ARCHIVED_NOTES.md** — Historical technical notes (transcription pipeline, graphics overlay debugging).

For contributor documentation, see [`../CONTRIBUTING.md`](../CONTRIBUTING.md).
For the public project overview, see the [repo root README](../../README.md).
