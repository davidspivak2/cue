...
- [`CAPTION_GRAPHICS_OVERLAY_PLAN.md`](CAPTION_GRAPHICS_OVERLAY_PLAN.md) — graphics overlay plan for caption rendering.
- [`GRAPHICS_OVERLAY_DEBUGGING.md`](GRAPHICS_OVERLAY_DEBUGGING.md) — debugging guidance for graphics overlay rendering.
- [`PR10_WORD_HIGHLIGHT_PLAN.md`](PR10_WORD_HIGHLIGHT_PLAN.md) — word highlight implementation plan and milestones.
